...
describe("Button", () => {
  ...
  it("should has the correct type class when type prop is set", () => {
    ...
    types.forEach((type) => {
      ...
      expect(wrapper.classes()).toContain(`melody-button--${type}`);
    });
  });
  ...
  it("should has the correct size class when size prop is set", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(`melody-button--${size}`);
    });
  });
...
describe("ButtonGroup.vue", () => {
  test("basic button group", async () => {
    ...
    expect(wrapper.classes()).toContain("melody-button-group");
  });
  ...
  test("button group size", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(buttonWrapper.classes()).toContain(`melody-button--${size}`);
    });
  });
  ...
  test("button group type", () => {
    ...
    types.forEach((type) => {
      ...
      const buttonWrapper = wrapper.findComponent(Button);
      expect(buttonWrapper.classes()).toContain(`melody-button--${type}`);
    });
  });
